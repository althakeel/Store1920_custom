...
- Cash on Delivery (COD) - available for most UAE orders
            ...
            if (apiError.message?.includes('429') || apiError.message?.includes('quota') || apiError.status === 429) {
                ...
                const fallbackResponses = {
                    english: {
                        ...
                        'shipping': "we've got you covered with fast & reliable shipping across the UAE! 🚚📦\n\n✅ Free Shipping on orders above AED499\n⏱️ Delivery Time:\n  • Standard: 2-5 business days\n  • Express: 1-3 business days (select areas/products)\n\n📍 Shipping Features:\n  • Real-time order tracking\n  • SMS & email updates\n  • Doorstep delivery\n  • Safe & secure packaging\n\n💰 Shipping Charges: Nominal fee for orders below AED499 (shown at checkout)\n\nenter your emirate and address at checkout to see exact delivery estimates! 🎯",
