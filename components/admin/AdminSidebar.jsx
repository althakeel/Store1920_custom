...
import { HomeIcon, ShieldCheckIcon, StoreIcon, TicketPercentIcon, TagsIcon, ImageIcon, LogInIcon, HistoryIcon } from "lucide-react"
...
const AdminSidebar = () => {
    ...
    const sidebarLinks = [
        ...
        { name: 'Inventory History', href: '/admin/inventory-history', icon: HistoryIcon },
        ...
        { name: 'Sign-In Modal', href: '/admin/sign-in-modal', icon: LogInIcon },
    ]

    return (
        <div className="inline-flex h-full flex-col gap-5 border-r border-slate-200 sm:min-w-60">
            <div className="flex flex-col gap-3 justify-center items-center pt-8 max-sm:hidden">
                <Image className="w-14 h-auto rounded-full" src={require("../../assets/logo/Store1920.png")} alt="Admin Logo" width={80} height={80} />
