...
export async function sendTicketCreatedEmail(ticket) {
  const adminEmail = process.env.ADMIN_EMAIL || 'admin@Store1920.com';
    ...
    await sendMail({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto;">
          ...
          <a href="${buildCustomerSitePath(`/dashboard/tickets/${ticket._id}`)}" 
    ...
    await sendMail({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto;">
          ...
          <a href="${buildCustomerSitePath('/store/tickets')}" 
