...
export const HOME_SECTION_TITLE_CLASS = 'mb-4 px-3 text-base font-semibold sm:mb-5 sm:px-0 sm:text-lg md:text-[28px]'

export const HOME_PRODUCT_GRID_CLASS = 'grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6'
