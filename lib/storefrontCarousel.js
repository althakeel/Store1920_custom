...
export const CATEGORY_SLIDER_SIDE_IMAGE_SIZE_CLASS = 'w-[240px] xl:w-[280px] 2xl:w-[320px]';

export const CATEGORY_SLIDER_SIDE_IMAGE_CLASS = `relative mb-4 hidden aspect-square ${CATEGORY_SLIDER_SIDE_IMAGE_SIZE_CLASS} shrink-0 overflow-hidden rounded-2xl bg-slate-100 lg:mb-0 lg:block lg:self-center`;

export const SIDE_IMAGE_SLIDER_PANEL_CLASS = 'lg:flex lg:h-full lg:min-h-0 lg:w-full lg:flex-col lg:justify-center';
