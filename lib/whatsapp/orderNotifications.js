...
export async function sendOrderPlacedWhatsApp(order) {
  try {
    return await sendOrderConfirmationWhatsApp(order, WABA_TEMPLATE_NAMES.orderPlaced, {
...
export async function sendOrderPaidWhatsApp(order) {
  try {
    ...
    return await sendOrderConfirmationWhatsApp(order, WABA_TEMPLATE_NAMES.paidOrderConfirmation, {
