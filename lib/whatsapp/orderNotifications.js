...
import { DEFERRED_PAYMENT_METHODS, shouldSendOrderConfirmationOnCreate } from '@/lib/orderConfirmationPolicy';
...
function shouldSendConfirmationOnCreate(order, paymentMethod) {
  return shouldSendOrderConfirmationOnCreate(order, paymentMethod);
}
