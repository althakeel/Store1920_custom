...
export function getProductBundleMode(product = {}) {
  ...
  // Trust explicit bulk flag, then variant shape (Buy 1 / Buy 2 / Buy 3 tiers),
  // before falling back to variant_bundles — avoids showing a variant picker for
  // bundle-only products that were previously saved as matrix.
