...
export const promotionalTemplates = [
  {
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
  ...
  {
    id: 'trending-now',
    subject: 'Trending Now on Store1920 🔥',
    title: 'Trending Now',
    subtitle: 'on Store1920',
    emoji: '🔥',
    color: '#ec4899',
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        <div style="background: linear-gradient(135deg, #ec4899 0%, #db2777 100%); padding: 40px 20px; text-align: center; color: #ffffff;">
          ...
          <p style="margin: 10px 0 0 0; font-size: 18px; opacity: 0.95;">on Store1920</p>
        </div>
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #ec4899; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(236, 72, 153, 0.3);">
              See Trending
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #f43f5e; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(244, 63, 94, 0.3);">
              Check Wishlist
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #dc2626; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(220, 38, 38, 0.3);">
              Shop Now
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #06b6d4; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(6, 182, 212, 0.3);">
              Discover Now
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #ea580c; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(234, 88, 12, 0.3);">
              Grab Deals
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #3b82f6; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(59, 130, 246, 0.3);">
              Shop Smart
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #10b981; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(16, 185, 129, 0.3);">
              View Popular
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #7c3aed; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(124, 58, 237, 0.3);">
              Save Now
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #0d9488; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(13, 148, 136, 0.3);">
              Shop Essentials
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #f97316; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(249, 115, 22, 0.3);">
              Shop Now
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #8b5cf6; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(139, 92, 246, 0.3);">
              Start Shopping
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #14b8a6; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(20, 184, 166, 0.3);">
              Explore Deals
            </a>
          </div>
        </div>
  ...
  },
  {
    ...
    emoji: '💡',
    color: '#eab308',
    content: 'Smart shoppers choose Store1920. Get more for less!',
    cta: 'Shop Smart',
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          <p style="font-size: 16px; line-height: 1.6; color: #374151; margin: 0 0 24px 0;">
            Smart shoppers choose Store1920. Get more for less!
          </p>
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #eab308; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(234, 179, 8, 0.3);">
              Shop Smart
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #6366f1; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(99, 102, 241, 0.3);">
              See Products
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com'}" style="display: inline-block; background: #f59e0b; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(245, 158, 11, 0.3);">
              Shop Deals
            </a>
          </div>
        </div>
  ...
  {
    id: 'love-Store1920',
    subject: 'Store1920 Finds You\'ll Love ❤️',
    title: 'Store1920 Finds',
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 620px; width: 100%; margin: 0 auto; background: #ffffff;">
        <div style="background: linear-gradient(135deg, #f43f5e 0%, #e11d48 100%); padding: 40px 20px; text-align: center; color: #ffffff;">
          <h1 style="font-size: 42px; margin: 0 0 10px 0;">❤️</h1>
          <h2 style="margin: 0; font-size: 28px; font-weight: 700;">Store1920 Finds You'll Love</h2>
...
function generateProductGrid(products = []) {
  ...
  const currency = 'AED';
  const baseUrl = process.env.NEXT_PUBLIC_BASE_URL || 'https://Store1920.com';
      ...
      <div style="background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); padding: 24px 16px; border-radius: 18px; border: 2px solid #0ea5e9; overflow: hidden;">
        ...
        <div style="display: flex; gap: 16px; overflow-x: auto; padding-bottom: 12px; scroll-behavior: smooth; -webkit-overflow-scrolling: touch;">
          ${products.slice(0, 4).map((product, index) => {
            ...
            const productUrl = getProductAbsoluteUrl(product, baseUrl);
  ...
  return `
    <div style="background: linear-gradient(180deg, #0f172a 0%, #1a202c 100%); padding: 40px 30px; text-align: center; color: #cbd5e1;">
      <div style="margin-bottom: 20px;">
        ${emailLogoImg('max-width:160px;height:auto;display:inline-block;margin-bottom:12px;')}
      ...
      <p style="margin: 16px 0 8px 0; font-size: 13px; color: #94a3b8;">© ${new Date().getFullYear()} Store1920. All rights reserved. 🔐</p>
      <p style="margin: 0 0 12px 0; font-size: 13px; color: #94a3b8;">
        Questions? Email <a href="mailto:${STORE1920_SUPPORT_EMAIL}" style="color: #cbd5e1; text-decoration: underline; font-weight: 600;">${STORE1920_SUPPORT_EMAIL}</a>
      </p>
      ...
      <div style="border-top: 1px solid #334155; padding-top: 12px; margin-top: 12px;">
        <p style="margin: 0 0 8px 0; font-size: 11px; color: #64748b;">You received this email because you have an account with Store1920.</p>
