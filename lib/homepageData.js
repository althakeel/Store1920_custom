...
const HOMEPAGE_CACHE_KEY = 'server:homepage:v3';
...
async function fetchStoreMenuSettings() {
  ...
  return {
    ...
    navMenuUseParentCategories: Boolean(doc?.navMenuUseParentCategories),
...
export async function getHomepageData(language = 'en') {
  ...
  setCachedData(HOMEPAGE_CACHE_KEY, payload, HOMEPAGE_TTL);
  return payload;
}
