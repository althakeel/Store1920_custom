...
export function useHorizontalCarouselDrag({
  ...
  const trackClassName = `flex ${PRODUCT_CARD_CAROUSEL_GAP_CLASS} overflow-x-auto pb-2 scrollbar-hide overscroll-x-contain snap-x snap-proximity md:snap-mandatory scroll-smooth touch-pan-x select-none ${
