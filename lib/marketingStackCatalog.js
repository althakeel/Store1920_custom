export const MARKETING_STACK_SECTIONS = [
  {
    ...
    items: [
      ...
      { id: 'heatmap', name: 'Heatmap data collection', desc: 'Record click coords per page. Replay or visualize density without third-party tools.', tag: 'adv', status: 'planned' },
    ],
  },
  {
    id: 'journey',
    ...
    items: [
      ...
      { id: 'cohort-tracking', name: 'Cohort tracking', desc: 'Group customers by acquisition date/channel. Track retention and LTV over time.', tag: 'must', status: 'planned' },
      ...
      { id: 'churn-score', name: 'Predictive churn score', desc: 'ML model trained on your data. Score stored per customer, updated weekly.', tag: 'adv', status: 'planned' },
    ],
  },
  {
    id: 'segmentation',
    ...
    items: [
      ...
      { id: 'rfm-scoring', name: 'RFM scoring', desc: 'Auto-calculate Recency, Frequency, Monetary score. Update daily via cron.', tag: 'nice', status: 'planned' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'behavioral-triggers', name: 'Behavioral trigger engine', desc: 'Fire emails/SMS on events: first purchase, 90-day no-order, birthday.', tag: 'nice', status: 'planned' },
