...
export const PERMISSION_GROUPS = [
    {
        id: 'store',
        label: 'Store & catalog',
        componentIds: ['dashboard', 'categories', 'addProduct', 'manageProduct', 'databaseImport', 'customize', 'menuManagement', 'media', 'settings'],
    },
    {
        id: 'sales',
        label: 'Orders & customers',
        componentIds: ['orders', 'customers', 'customerTracking', 'abandonedCheckout', 'shipping', 'returnRequests', 'balance', 'salesReport'],
    },
    {
        id: 'marketing',
        label: 'Marketing',
        componentIds: ['promotionalOffers', 'coupons', 'giveaways', 'spinWheel', 'promotionalEmails', 'customerTracking', 'marketingAnalytics', 'marketingStack', 'adsTracking', 'marketingExpenses'],
    },
    {
        id: 'support',
